# Following https://www.kaggle.com/atikur/simple-gru-with-fasttext-lb-0-9847/notebook
...
if not is_in_cache('lvl1_gru128-2'):
    ...
    model.compile(loss='binary_crossentropy',
                  optimizer='rmsprop',
                  metrics=['accuracy'])
    model.save_weights('cache/gru128-2-model-weights.h5')
    ...
    for dev_index, val_index in kf.split(x_train, y_train[:, 0]):
        ...
        model.load_weights('cache/gru128-2-model-weights.h5')
    ...
    for k, classx in enumerate(classes):
        train_df['gru128-2_' + classx] = pred_train[:, k]
        test_df['gru128-2_' + classx] = pred_full_test[:, k]

    print('~~~~~~~~~~~~~~~~~~')
    print_step('Cache Level 1')
    save_in_cache('lvl1_gru128-2', train_df, test_df)
    print_step('Done!')
...
submission['toxic'] = test_df['gru128-2_toxic']
submission['severe_toxic'] = test_df['gru128-2_severe_toxic']
submission['obscene'] = test_df['gru128-2_obscene']
submission['threat'] = test_df['gru128-2_threat']
submission['insult'] = test_df['gru128-2_insult']
submission['identity_hate'] = test_df['gru128-2_identity_hate']
submission.to_csv('submit/submit_lvl1_gru128-2.csv', index=False)
print_step('Done')
# ('toxic', 0.9833006646207911),
# ('severe_toxic', 0.9906564017783241),
# ('obscene', 0.9923388911442622),
# ('threat', 0.9900992405968848),
# ('insult', 0.9876401876293406),
# ('identity_hate', 0.988791546714779)]
# ean cv score : 0.9888044887473971
