...
def add_features(train, test):
    ...
    print_step('POS 3/26')
    train2['has_foreign_word'] = train2['pos_space'].apply(lambda ws: any(['FW' in w[1] for w in ws])).astype('int64')
    test2['has_foreign_word'] = test2['pos_space'].apply(lambda ws: any(['FW' in w[1] for w in ws])).astype('int64')
    print_step('POS 4/26')
    ...
    train2['has_modal_then_verb'] = train2['pos_space'].apply(lambda ws: 'MD VB' in ' '.join([w[1] for w in ws])).astype('int64')
    test2['has_modal_then_verb'] = test2['pos_space'].apply(lambda ws: 'MD VB' in ' '.join([w[1] for w in ws])).astype('int64')
    print_step('POS 22/26')
    train2['has_personal_pronoun_then_singular_present_verb'] = train2['pos_space'].apply(lambda ws: 'PRP VBP' in ' '.join([w[1] for w in ws])).astype('int64')
    test2['has_personal_pronoun_then_singular_present_verb'] = test2['pos_space'].apply(lambda ws: 'PRP VBP' in ' '.join([w[1] for w in ws])).astype('int64')
    print_step('POS 23/26')
    train2['has_adjective_then_noun'] = train2['pos_space'].apply(lambda ws: 'JJ NN' in ' '.join([w[1] for w in ws])).astype('int64')
    test2['has_adjective_then_noun'] = test2['pos_space'].apply(lambda ws: 'JJ NN' in ' '.join([w[1] for w in ws])).astype('int64')
    print_step('POS 24/26')
    train2['has_noun_then_preposition'] = train2['pos_space'].apply(lambda ws: 'NN IN' in ' '.join([w[1] for w in ws])).astype('int64')
    test2['has_noun_then_preposition'] = test2['pos_space'].apply(lambda ws: 'NN IN' in ' '.join([w[1] for w in ws])).astype('int64')
    print_step('POS 25/26')
    train2['has_verb_then_you'] = train2['pos_space'].apply(has_verb_you).astype('int64')
    test2['has_verb_then_you'] = test2['pos_space'].apply(has_verb_you).astype('int64')
    print_step('POS 26/26')
    train2['has_you_then_verb'] = train2['pos_space'].apply(has_you_verb).astype('int64')
    test2['has_you_then_verb'] = test2['pos_space'].apply(has_you_verb).astype('int64')
